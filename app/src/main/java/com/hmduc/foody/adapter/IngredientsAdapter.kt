...
import com.hmduc.foody.models.ExtendedIngredient
import com.hmduc.foody.util.Constants.Companion.BASE_IMAGE_URL
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return MyViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.ingredient_row, parent, false))
    }
    ...
    fun setData(ingredients: List<ExtendedIngredient>) {
        val ingredientsDiffUtil = RecipesDiffUtil(ingredientList,ingredients)
